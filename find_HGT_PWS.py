...
eggnog_file = open(prefix + '_eggnog.emapper.annotations', 'r')

## Parse the diamond output, into seq2skingdom_dict
seq2skingdom_dict = {}
for line in diamond_file:
	line = line.strip('\n')
	qseqid,sseqid,pident,length,mismatch,gapopen,qstart,qend,sstart,send,evalue,bitscore,staxids,sskingdoms,skingdoms,sphylums,sscinames = line.split('\t')
